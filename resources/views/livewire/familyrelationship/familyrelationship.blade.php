...
new class extends Component {
    ...
    public function familyrelationships(): LengthAwarePaginator
    {
    ...
    {
        return [
            'familyrelationships' => $this->familyrelationships(),
...
<div>
    ...
    <x-card>
        <x-table :headers="$headers" :rows="$familyrelationships" :sort-by="$sortBy" with-pagination>
